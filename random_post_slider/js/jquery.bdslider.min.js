            ...
            a.ajax({
                ...
                success: function(a) {
                    ...
                    for (f = "", f += '<div class="flexslider loading" style="max-width:' + c.imageWidth + 'px">', f += '<ul class="slides">', g = 0; g < e.length; ++g) {
                        ...
                        n = m[h].href, o = '<img src="' + l + '" width="' + c.imageWidth + '" height="' + c.imageHeight + '"/>', p = c.showPostTitle ? '<p class="flex-caption' + ("default" == c.postTitleStyle ? "" : " " + c.postTitleStyle) + '"><span>' + j + "</span></p>" : "", q = '<a href="' + n + '" target="_parent" title="' + j + '">' + o + p + "</a>", f += "<li>" + q + "</li>"
                    }
